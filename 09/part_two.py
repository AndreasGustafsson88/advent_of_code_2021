...
def search(searching_idx, local_basin):
    while searching_idx:
        ...
        [searching_idx.append(i) if i and i not in local_basin and i not in searching_idx else None for i in new_idx]
...
def find_basins(cave_floor: np.array, lows: list[list]):
    ...
    for low in lows:
        ...
        search(searching_idx, local_basin)
